...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['pesan'])) {
        ...
        $queryImport = "update barang set namaBarang='$namaBarang', jenis='$jenis', deskripsi='$deskripsi', stock='$stock', harga='$harga', gambar='$gambar' where idBarang='$id'";
            ...
            if (isset($_GET['id'])) {
                ...
                while ($row = mysqli_fetch_array($resultSelect)) {
                    ...
                    <form action="edit.php?id=<?=$id?>" method="post" enctype="multipart/form-data">
                        <input type="text" name="namaBarang" value="<?= $row['namaBarang'] ?>">
